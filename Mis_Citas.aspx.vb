    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If dv IsNot Nothing AndAlso dv.Count <> 0 Then
            ...
            ElseIf Integer.TryParse(lbRol.Text, Nothing) AndAlso CInt(lbRol.Text) = 3 Then
                ...
                Dim dv2 As DataView = DirectCast(DS_Empleado.Select(DataSourceSelectArguments.Empty), DataView)
                If dv2 IsNot Nothing AndAlso dv2.Count <> 0 Then
                    Session("ID") = dv2.Table.Rows(0)(0).ToString()
                    lbEmpleadoCita.Text = 2

                    Session("Rol") = dv2.Table.Rows(0)(1).ToString()

                    lbRol.Text = Session("Rol")
                    If lbRol.Text = 3 Then
                ...
                End If
            Else
                Dim dv3 As DataView = DirectCast(DS_Local.Select(DataSourceSelectArguments.Empty), DataView)
                If dv3 IsNot Nothing AndAlso dv3.Count <> 0 Then
                    Session("ID") = dv3.Table.Rows(0)(0).ToString()
                    lbLocalCita.Text = 1
                    Session("Rol") = dv3.Table.Rows(0)(1).ToString()
                    lbRol.Text = Session("Rol")
